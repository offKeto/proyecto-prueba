...
<template>
    <div class="leg flex min-h-screen flex-col items-center gap-5 bg-slate-300">
        <div
            class="mx-20 my-30 inline-block min-h-10/12 w-2/5 rounded-2xl bg-slate-200 p-6 text-justify text-lg font-semibold text-gray-200 shadow-2xl"
        >
            <h1 class="mb-10 text-center text-4xl font-bold text-black">Login</h1>
            <form @submit.prevent="login" class="flex flex-wrap items-center justify-center gap-2 text-black">
                <h2>User:</h2>
